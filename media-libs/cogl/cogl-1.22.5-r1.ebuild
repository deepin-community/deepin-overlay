...
pkg_postinst() {
	einfo "This is the Deepin fork of cogl. If it breaks any"
	einfo "existing packages in your system, unmerge the Deepin"
	einfo "packages depending on cogl and remerge media-libs/cogl::gentoo."
}
